...
SSD1306Wire display(0x3c, PIN_I2C_SDA, PIN_I2C_SCL); // I2C address & pins from pin_config.h
...
// WebSocket server: ESP-IDF compatible replacement
...
// ESP-IDF: Use gpio_get_level() for digitalRead (defined in Arduino.h compat)
// Removing the ESP8266-specific fast GPIO macro
#undef digitalRead
...
void externalClockGenDetectAndInitialize()
{
    ...
    Wire.beginTransmission(SIADDR);
    Wire.write((uint8_t)0); // Device Status
